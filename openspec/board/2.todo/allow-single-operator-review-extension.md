...
## Next
- Выполнить принятый OpenSpec change через native runner: реализация, независимое review, sync/archive, final checks и штатные commit/push. Сохранять frozen plan, history и accounting.
