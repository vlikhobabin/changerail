...
- [x] 1.1 Keep the authorization card out of `4.done` during delivery; publish
  ...
  and verified.
- [x] 1.2 Publish exactly one machine-readable authorization object on the
...
- [x] 3.1 Run `./bin/openspec validate "authorize-bounded-review-fingerprint-payload" --strict`.
