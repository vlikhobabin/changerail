...
- **AND** the fixture fails if default content reaches the 70 percent generated
  instruction target
...
#### Scenario: Shared methodology is upgraded
- **WHEN** a ChangeRail release changes `AGENTS.shared.md`
- **THEN** adoption guidance requires maintainers to inventory every consumer
  and review its marker-bounded generated section
- **AND** it requires review of the project-specific prefix and rerunning the
  consumer verification baseline
