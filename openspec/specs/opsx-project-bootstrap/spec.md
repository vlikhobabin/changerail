# opsx-project-bootstrap Specification

## Purpose
Зафиксировать command-line bootstrap flow, который создает generic OPSX
consumer project из tracked templates, OPSX source-of-truth symlink-ов и
