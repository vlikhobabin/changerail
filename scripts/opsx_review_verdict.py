#!/usr/bin/env python3
"""Validate OPSX review verdicts and compute working-tree freshness fingerprints.

The review verdict (`opsx.review-verdict.v1`) is the machine gate between
`$opsx-do` and `$opsx-pub`: a card publish that is part of the review-gated
...
SCHEMA_ID = "opsx.review-verdict.v1"
