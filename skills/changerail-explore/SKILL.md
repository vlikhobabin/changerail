---
name: changerail-explore
description: Short ChangeRail alias for OpenSpec explore mode. Use when the user asks for `$changerail-explore`, `changerail:explore`, `/changerail:explore`, or wants to explore an idea, problem, architecture, requirement, or active OpenSpec change before implementation.
---
...
Enter ChangeRail/OpenSpec explore mode with a short command:
